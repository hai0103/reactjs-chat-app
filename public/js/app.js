...
var _componentsUsers = require('./components/users');
...
var _componentsMessageList = require('./components/message-list');

var _componentsMessageList2 = _interopRequireDefault(_componentsMessageList);

var _componentsMessageForm = require('./components/message-form');

var _componentsMessageForm2 = _interopRequireDefault(_componentsMessageForm);

var _componentsChangeNameForm = require('./components/change-name-form');

var _componentsChangeNameForm2 = _interopRequireDefault(_componentsChangeNameForm);

var _chatApp = require('./chat-app');
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'area-chat-box card col-8 shadow' },
					React.createElement(_componentsMessageList2['default'], {
						messages: this.state.messages
					}),
					React.createElement(_componentsMessageForm2['default'], {
				...
				React.createElement(
					'div',
					{ className: 'card col-4 shadow p-4' },
					React.createElement(_componentsUsers2['default'], {
						users: this.state.users
					}),
					React.createElement(_componentsChangeNameForm2['default'], {
...
React.render(React.createElement(ChatApp1, null), document.getElementById('app'));

},{"./chat-app":2,"./components/change-name-form":3,"./components/message":6,"./components/message-form":4,"./components/message-list":5,"./components/users":7,"react":163}],2:[function(require,module,exports){
'use strict';
	...
	_createClass(ChatApp, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				'div',
				null,
				_react2['default'].createElement(_componentsUsers2['default'], {
					users: this.state.users
				}),
				_react2['default'].createElement(_componentsMessageList2['default'], {
					messages: this.state.messages
				}),
				_react2['default'].createElement(_componentsMessageForm2['default'], {
					onMessageSubmit: this.handleMessageSubmit,
					user: this.state.user
				}),
				_react2['default'].createElement(_componentsChangeNameForm2['default'], {
					onChangeName: this.handleChangeName
				})
			);
		}
...
},{"./components/change-name-form":3,"./components/message":6,"./components/message-form":4,"./components/message-list":5,"./components/users":7,"react":163}],3:[function(require,module,exports){
'use strict';
...
var ChangeNameForm = (function (_React$Component) {
	_inherits(ChangeNameForm, _React$Component);

	function ChangeNameForm(props) {
		_classCallCheck(this, ChangeNameForm);

		_get(Object.getPrototypeOf(ChangeNameForm.prototype), 'constructor', this).call(this, props);
		this.state = {
			newName: ''
		};
	}
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'button',
                        { type: 'button', className: 'btn btn-success ml-3',
                            onClick: function (e) {
                                return _this.handleSubmit(e);
                            }
                        },
...
},{"./message":6,"react":163}],6:[function(require,module,exports){
"use strict";
